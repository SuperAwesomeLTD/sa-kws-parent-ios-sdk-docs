Kids Web Services iOS (for Parental engagement) SDK
===================================================
...
Info        Contents
=========== ========
Version     <sdk_version> (`Changelog <https://github.com/SuperAwesomeLTD/sa-kws-parent-ios-sdk/blob/master/CHANGELOG.md>`_)
Support 		<sdk_min>
GitHub      <sdk_source>
Contact     `<sdk_devsuspport> <mailto:<sdk_devsuspport>>`_
License     `GNU Lesser General Public License Version 3 <https://github.com/SuperAwesomeLTD/sa-kws-parent-ios-sdk/blob/master/LICENSE>`_
=========== ========
